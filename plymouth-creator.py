...
#      installFile.write("sudo update-initramfs -u\n")
      installFile.write("sudo plymouth-set-default-theme -R /usr/share/plymouth/themes/" + name + "\n")
...
#      installFile.write("sudo plymouth quit\n")
      installFile.write("echo Done!\n")
      installFile.write("echo Reboot your system to see the changes... hopefully...")
...
#      uninstallFile.write("sudo plymouth quit\n")
      uninstallFile.write("echo Done!\n")
      uninstallFile.write("echo this should hopefully fix everything back to normal... i hope..")
